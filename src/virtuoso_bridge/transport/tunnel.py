...
def _generate_virtuoso_setup_il(
    ...
    return (
        ...
        f"; Profile: {profile_value or '(default)'}\n"
        f"; Remote port: {port}\n"
        f"; Nonce: {nonce}\n"
        ...
        f'setShellEnvVar("RB_PROFILE" "{profile_value}")\n'
        f'setShellEnvVar("RB_DAEMON_NONCE" "{nonce}")\n'
        f'printf("[RAMIC Bridge setup] profile={profile_value or "(default)"} port={port} nonce={nonce}\\n")\n'
        "\n"
...
class SSHClient:
    ...
    def __init__(
        ...
        self._daemon_nonce = secrets.token_hex(8)
    ...
    def save_state(self) -> None:
        ...
        state = {
            ...
            "profile": self._profile,
            "daemon_nonce": self._daemon_nonce,
