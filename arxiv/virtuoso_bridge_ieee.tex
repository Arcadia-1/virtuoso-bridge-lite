...
The system has been verified in a production tape-out workflow. The complete version of the harness, from which virtuoso-bridge-lite is distilled, was used in the development of AMS-IO-Agent~\cite{amsioagent}, where an LLM-based agent autonomously completed I/O ring design tasks with outputs directly used in silicon fabrication. That work demonstrated the practical necessity of a stable, remote-capable bridge for agent-driven AMS design.
